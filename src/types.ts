...
export const DEFAULT_AVATARS: { id: string; label: string; url: string; color: string }[] = [
  ...
  { id: "avatar-6", label: "Moss Fern Canopy", url: "https://images.unsplash.com/photo-1448375240586-882707db888b?auto=format&fit=crop&w=300&q=80", color: "#b58974" },
  { id: "avatar-7", label: "Redwood Trail", url: "https://images.unsplash.com/photo-1502082553048-f009c37129b9?auto=format&fit=crop&w=300&q=80", color: "#d2a649" },
  { id: "avatar-8", label: "Misty Trail Path", url: "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&w=300&q=80", color: "#f0d58c" },
  { id: "avatar-9", label: "Amber Stream", url: "https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=300&q=80", color: "#ffaa00" },
  ...
  { id: "avatar-12", label: "Dewy Autumn Leaf", url: "https://images.unsplash.com/photo-1518531933037-91b2f5f229cc?auto=format&fit=crop&w=300&q=80", color: "#d2a649" },
  { id: "avatar-13", label: "Golden Autumn Glade", url: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=300&q=80", color: "#b58974" },
  ...
  { id: "avatar-17", label: "Wild Hummingbird", url: "https://images.unsplash.com/photo-1555169062-013468b47731?auto=format&fit=crop&w=300&q=80", color: "#d2a649" },
  { id: "avatar-18", label: "Lush Mossy Stone", url: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?auto=format&fit=crop&w=300&q=80", color: "#f0d58c" },
  { id: "avatar-19", label: "Aurora Canopy", url: "https://images.unsplash.com/photo-1531366936337-7c912a4589a7?auto=format&fit=crop&w=300&q=80", color: "#b58974" },
  { id: "avatar-20", label: "Twilight Woods", url: "https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?auto=format&fit=crop&w=300&q=80", color: "#d2a649" },
];
